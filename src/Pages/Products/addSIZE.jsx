...
const AddSIZE = () => {
  ...
  const editItem = (id) => {
    fetchDataFromApi(`/api/product/getproductSize/${id}`).then((res) => {
  ...
  return (
    <>
      <div className="col1 flex items-center justify-between my-3">
        <h1 className='font-[700] text-[22px] text-gray-800'>Add Products Size's</h1>
      ...
      <div className="card my-4 pt-5 shadow-md rounded-md  bg-white w-[85%]">
        ...
        <form className='form p-5 ' onSubmit={handleSubmit}>
          ...
          <div className="col mb-6">
            <h3 className='text-[14px] font-[600] mb-2'>Product Size's</h3>
